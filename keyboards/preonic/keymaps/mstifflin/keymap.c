...
[_DEFAULT] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL,       KC_LALT, KC_LALT, KC_LGUI, TG(_LOWER), KC_SPC,  KC_SPC,  MO(_RAISE), KC_LBRACKET, KC_RBRACKET, KC_AUDIO_VOL_UP,   KC_AUDIO_VOL_DOWN \
),
